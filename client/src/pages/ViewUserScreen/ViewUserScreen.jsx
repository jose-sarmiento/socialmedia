...
function ViewUserScreen() {
    ...
    //   navigate('/messages', { state: { newChat: true}});
    //   dispatch(createChatReset());
    // }, [createdChat, navigate, dispatch]);
            ...
            const newChat = {
                ...
                members: [
                    ...
                    { _id: viewUser._id,
                        ...
                        profileImage: viewUser.profileImage },
                ],
                messages: [],
                createdAt: +new Date(),
            };
            dispatch(createEmptyChat({chat: newChat}))
            navigate("/messages");
        }
    };
            ...
            <div className="profile__cover">
                {viewUser.coverImage && (
                    <img
                        src={
                            viewUser.coverImage ||
                            "https://www.freeiconspng.com/img/23480"
                        }
                        alt="cover"
