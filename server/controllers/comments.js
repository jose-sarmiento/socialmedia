...
const deleteComment = async (req, res) => {
  ...
  res
    ...
    .json({ deleted: true, message: 'Comment deleted successfully' });
};
...
const likeComment = async (req, res) => {
  ...
  const reactor = comment.reactors.findIndex((x) => x.equals(req.user._id));
...
const likeReply = async (req, res) => {
  ...
  const reactor = reply.reactors.findIndex((x) => x.equals(req.user._id));
